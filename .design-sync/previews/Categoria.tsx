import { Categoria } from 'tablero-casa-oga'
...
/** Lampara de pie: la categoria de producto, el objeto mas Casa Oga del set. Monolinea, trazo 1.4 a 1.5, siempre en currentColor: hereda el color
 *  del texto que lo acompana en vez de traer uno propio. */
export const Tamanos = () => (
  <div style={fila}>
    <Categoria />
    <Categoria width={20} height={20} />
    <Categoria width={32} height={32} />
    <Categoria width={48} height={48} />
  </div>
)
...
export const HeredaElColor = () => (
  <div style={fila}>
    <span style={{ color: 'var(--ink)' }}><Categoria width={28} height={28} /></span>
    <span style={{ color: 'var(--acc)' }}><Categoria width={28} height={28} /></span>
    <span style={{ color: 'var(--mut)' }}><Categoria width={28} height={28} /></span>
    <span style={{ color: 'var(--terra)' }}><Categoria width={28} height={28} /></span>
  </div>
)
...
export const EnElChipDeFiltro = () => (
  <div style={fila}>
    <Chip><Categoria width={14} height={14} /> Muebles</Chip>
      <Chip><Categoria width={14} height={14} /> Iluminacion</Chip>
  </div>
)
