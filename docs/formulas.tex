...
La Parte B (sección 3.1) y la Parte C (sección 1.3) citan que ``la mejor variable no circular llega a 1,22$\times$''. Esta sección define esa cifra y la reproduce.
