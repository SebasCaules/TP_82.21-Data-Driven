...
{\small\color[HTML]{8A8680} Anexo de fórmulas · v2.0 · 15/09/2026}
\else
\begin{center}
...
Entregable 1 --- Grupo 2 --- Anexo de fórmulas, v2.0\\[3mm]
\begin{tabular}{ll}
...
\begin{equation}
Y_i(T) = \mathbb{1}\bigl[\,B_i(T)=0 \ \wedge\ \exists\, t \in (T,\ T+90]:\ B_i(t)=1\,\bigr]
\label{eq:target}
\end{equation}

es decir, entre los clientes que al corte $T$ todavía no cruzaron su umbral, cuáles lo cruzan dentro de los 90 días siguientes. El modelo puntúa en $T$ la probabilidad de $Y_i(T)=1$ con señales que se mueven \emph{antes} del cruce: caída de frecuencia y de ticket respecto del propio historial, y desde el 08/09 reclamos, consultas de soporte y devoluciones. Se valida con holdout temporal (entrenar hasta un corte, evaluar sobre los 90 días siguientes), contra la línea base de ordenar por $\rho_i(T)$.
