...
Los siete indicadores de la Parte D sección 2.1 se trazan acá contra su implementación. Cinco ya quedaron definidos arriba; los otros dos (recompra y compra a 7 días) se definen en esta sección.
...
\valor{2025Q3 (último trimestre observable con horizonte al 31/12/2025): $\tau = 8{,}5\%$ ($n=$ 1.330 clientes calculables), contra la meta de 10-11\% y la referencia de 8-9\% que estimó el negocio en el relevamiento (envío 8 / planilla 23; no es una línea base medida: la serie estuvo entre 16\% y 19\% de 2023Q1 a 2025Q1) (\texttt{pipeline/build.py} meta, \texttt{meta\_recompra}/\texttt{base\_recompra}). Pico de la serie: 2024Q2 con 19,0\%.}
...
\valor{$p_0 = 1{,}21\%$, $n = 1.080$ por rama: MDE $= 1{,}71$ puntos porcentuales, 1,4 veces la tasa base. Con 80 de control por corte (240 en total) el MDE contra una rama de 1.080 es mayor; la vista 13 lo declara: tres cortes sólo detectan un efecto de 1,71 pp entre las dos ramas de mensaje, y el diseño sirve para aprender si el mensaje importa, no todavía para medir el recupero con precisión.}
