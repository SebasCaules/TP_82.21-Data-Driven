...
- **V04 Duplicados de cliente** — `{"antes": {"clientes": 5978, "elegibles", "en_riesgo", "pct": 49.6, "exposicion_M": 94.9}, "despues": {"clientes": 5634, …, "pct": 50.4, "exposicion_M": 96.4}, "personas_por_n_ids": [{"n_ids": 2, "personas": …}, …], "duplicados_con_actividad": 348}`.
